...
// Last modified July 2020 by Martin Reinoso for COMP30019 (OnValidate to have interactive change)
...
public class ConeScript : MonoBehaviour
{
    ...
    [SerializeField] private int numberOfVertices; // SerializeField Makes private variables visible in the inspector (but not editable via other classes)
    ...
    // Note that there is more than one way to do this - here we demonstrate two
    // ways based on whether we wish to share common vertices or not.
    Mesh CreateConeMesh()
    {
        Mesh m = new Mesh();
        m.name = "Cone";
